...
# Ajuster la branche si nécessaire
if ($currentBranch -eq "master") {
    $branche = "master"
} elseif ($currentBranch -eq "main") {
    $branche = "main"
}
Write-Host "  Branche cible: $branche" -ForegroundColor Green
...
Write-Host ""
Write-Host "4. Vérification du repository distant..." -ForegroundColor Yellow
