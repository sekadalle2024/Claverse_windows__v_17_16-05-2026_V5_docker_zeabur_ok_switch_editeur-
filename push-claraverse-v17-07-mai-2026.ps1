...
Write-Host "  Date: 07 Mai 2026                                              " -ForegroundColor Cyan
Write-Host "=================================================================" -ForegroundColor Cyan
Write-Host ""

# Configuration
$repoUrl = "https://github.com/sekadalle2024/Claverse_windows__v_17_07-05-2026_V5_docker_zeabur_ok_switch_editeur-.git"
$branche = "v17_backup_final"
$commitPrefix = "Sauvegarde ClaraVerse V17 - 07 Mai 2026"
...
if ($status) {
    ...
    Write-Host "  $($status.Count) fichiers" -ForegroundColor Gray
} else {
...
if ($currentBranch -ne $branche) {
    Write-Host "  ⚠️ Attention: Vous n'êtes pas sur la branche $branche" -ForegroundColor Yellow
    Write-Host "  Changement de branche..." -ForegroundColor Yellow
...
git add *.md *.txt "Doc_Github_Issue/" "Doc cross ref documentaire menu/" "Doc papier de travail javascript/" "deploiement-netlify/"
