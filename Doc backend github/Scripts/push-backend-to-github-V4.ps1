# ============================================================================
# Script de Sauvegarde Backend Python - Version V4 (Optimise)
# ============================================================================
# 
# Description: Sauvegarde le repository py_backend/ de maniere isolee.
# URL Cible: https://github.com/sekadalle2024/Back-end-python-V4_23_04_2026--tree-master.git
#
# Avantages de la Version V4:
...
Write-Step "Initialisation et Verifications V4"

$targetRepo = "https://github.com/sekadalle2024/Back-end-python-V4_23_04_2026--tree-master.git"
...
$commitMessage = "Sauvegarde Backend V4 - $date"
...
Write-Step "Execution de la Sauvegarde V4"
...
try {
    ...
    Write-Success "SAUVEGARDE V4 REUSSIE !"
} catch {
