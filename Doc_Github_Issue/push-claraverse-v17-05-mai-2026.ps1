...
# Date: 05 Mai 2026
# Repository: https://github.com/sekadalle2024/Claverse_windows__v_17_05-05-2026_V5_docker_zeabur_ok_switch_editeur-.git

Write-Host "=================================================================" -ForegroundColor Cyan
Write-Host "  Push ClaraVerse V17 - 05 Mai 2026                             " -ForegroundColor Cyan
Write-Host "  Solution pour projets volumineux (>140 MB)                    " -ForegroundColor Cyan
Write-Host "=================================================================" -ForegroundColor Cyan
Write-Host ""

# Configuration
$repoUrl = "https://github.com/sekadalle2024/Claverse_windows__v_17_05-05-2026_V5_docker_zeabur_ok_switch_editeur-.git"
$branche = "v17_backup_final"
$commitPrefix = "Sauvegarde ClaraVerse V17 - 05 Mai 2026"
...
git add *.md *.txt "Doc_Github_Issue/" "Doc zeabur docker/" "Doc backend switch/" "Doc backend github/"
...
Write-Host "   2. Verifier que le projet fonctionne correctement" -ForegroundColor White
Write-Host ""
