...
Write-Host "  Push ClaraVerse V17 en Commits Multiples - 11 Mai 2026        " -ForegroundColor Cyan
Write-Host "=================================================================" -ForegroundColor Cyan
Write-Host ""

# Configuration
$repoUrl = "https://github.com/sekadalle2024/Claverse_windows__v_17_11-05-2026_V5_docker_zeabur_ok_switch_editeur-.git"
$branche = "v17_backup_final"
$commitPrefix = "Sauvegarde ClaraVerse V17 - 11 Mai 2026"
...
if ($status) {
    ...
    Write-Host "  $($status.Count) fichiers en attente" -ForegroundColor Gray
} else {
...
git add "Doc menu demarrer/" "Doc export rapport/" "Doc_Lead_Balance/" "Doc_Etat_Fin/" "Doc zeabur docker/" "Doc cross ref documentaire menu/"
...
# Commit 5: Autres documentations et fichiers de configuration
Write-Host ""
Write-Host "Partie 5/6: Autres documentations..." -ForegroundColor Cyan
git add *.md *.txt *.ps1 "Doc_Github_Issue/" "Doc papier de travail javascript/" "Doc menu contextuel menu.js update/"
